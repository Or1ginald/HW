...
export type AffairType = {
    ...
    name: string
    priority: string
} // need to fix any //Один элементик
...
export const deleteAffair = (affairs: Array<AffairType>, _id: number): any => { // need to fix any
    return affairs.filter((e: AffairType) => {
        return e._id !== _id
    })// need to fix
}

function HW2() {
    const [affairs, setAffairs] = useState<Array<AffairType>>(defaultAffairs) // need to fix any //affairs - исходный массив
